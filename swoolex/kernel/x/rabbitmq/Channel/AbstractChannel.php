<?php
namespace x\rabbitmq\Channel;

use x\rabbitmq\Connection\AbstractConnection;
use x\rabbitmq\Exception\AMQPOutOfBoundsException;
use x\rabbitmq\Exception\AMQPOutOfRangeException;
use x\rabbitmq\Exception\AMQPRuntimeException;
use x\rabbitmq\Helper\DebugHelper;
use x\rabbitmq\Helper\Protocol\MethodMap080;
use x\rabbitmq\Helper\Protocol\MethodMap091;
use x\rabbitmq\Helper\Protocol\Protocol080;
use x\rabbitmq\Helper\Protocol\Protocol091;
use x\rabbitmq\Helper\Protocol\Wait080;
use x\rabbitmq\Helper\Protocol\Wait091;
use x\rabbitmq\Message\AMQPMessage;
use x\rabbitmq\Wire\AMQPReader;
...
abstract class AbstractChannel
{
    ...
    /** @var \ x\rabbitmq\Helper\DebugHelper */
    protected $debug;

    /** @var \ x\rabbitmq\Connection\AbstractConnection */
    ...
    /** @var \ x\rabbitmq\Helper\Protocol\Protocol080|\ x\rabbitmq\Helper\Protocol\Protocol091 */
    protected $protocolWriter;

    /** @var \ x\rabbitmq\Helper\Protocol\Wait080|\ x\rabbitmq\Helper\Protocol\Wait091 */
    protected $waitHelper;

    /** @var \ x\rabbitmq\Helper\Protocol\MethodMap080|\ x\rabbitmq\Helper\Protocol\MethodMap091 */
    protected $methodMap;

    /** @var string */
    protected $channel_id;

    /** @var \ x\rabbitmq\Wire\AMQPReader */
     ...
     * @throws \ x\rabbitmq\Exception\AMQPRuntimeException
     */
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        switch ($this->protocolVersion) {
            case self::PROTOCOL_091:
                self::$PROTOCOL_CONSTANTS_CLASS = '\x\rabbitmq\Wire\Constants091';
            ...
            case self::PROTOCOL_080:
                self::$PROTOCOL_CONSTANTS_CLASS = '\x\rabbitmq\Wire\Constants080';
                $c = self::$PROTOCOL_CONSTANTS_CLASS;
                $this->debug = new DebugHelper($c);
                $this->amqp_protocol_header = $c::$AMQP_PROTOCOL_HEADER;
     ...
     * @param \ x\rabbitmq\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \ x\rabbitmq\Wire\AMQPWriter|string $args
     * @param \ x\rabbitmq\Wire\AMQPWriter $pkt
     * @return \ x\rabbitmq\Wire\AMQPWriter
     */
     ...
     * @return \ x\rabbitmq\Message\AMQPMessage
     */
     ...
     * @param int $timeout
     * @throws \ x\rabbitmq\Exception\AMQPOutOfBoundsException
     * @throws \ x\rabbitmq\Exception\AMQPRuntimeException
     * @return mixed
     */
