...
class Loader {
    ...
    */
    public static function register($autoload = '') {
        ...
        // Composer地址
        self::$composerPath = $rootPath . 'vendor' . DS . 'composer' . DS;
        ...
        // 加载类库映射文件
        if (is_file($rootPath . 'config' . DS . 'classmap.php')) {
            self::addNamespace(__include_file($rootPath . 'config' . DS . 'classmap.php'));
        }
        if (is_file($rootPath . 'config' . DS . 'classone.php')) {
            self::addClassMap(__include_file($rootPath . 'config' . DS . 'classone.php'));
        }
